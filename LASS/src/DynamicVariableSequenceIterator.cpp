...
#ifndef __DYNAMIC_VARIABLE_SEQUENCE_ITERATOR_CPP
#define __DYNAMIC_VARIABLE_SEQUENCE_ITERATOR_CPP
...
//----------------------------------------------------------------------------//
DynamicVariableSequenceIterator* DynamicVariableSequenceIterator::clone()
{
    return (new DynamicVariableSequenceIterator(*this));
}


//----------------------------------------------------------------------------//
bool DynamicVariableSequenceIterator::hasNext()
{
...
//----------------------------------------------------------------------------//
#endif // __DYNAMIC_VARIABLE_SEQUENCE_ITERATOR_CPP
